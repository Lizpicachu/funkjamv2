	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'scientist':
				...
				animation.addByPrefix('singLEFT', 'Scientist Sing left', 24);

				addOffset('idle', 50, -200);
				addOffset("singUP", 50, -200);
				addOffset("singRIGHT", 50, -200);
				addOffset("singLEFT", 50, -200);
				addOffset("singDOWN", 50, -200);
		...
		case 'bf-mod':
				var tex = Paths.getSparrowAtlas('bf-mod');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
